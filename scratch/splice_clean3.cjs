...
// 1. Delete Menu Item, Category, Table, Reservation states
deleteLines(
...
if (mStart !== -1) {
  ...
  // The end of ManagerDashboard.tsx is:
  //     </div>
  //   );
  // };
  // export const ManagerDashboard = ... or something? No it's } from './manager/ManagerDashboardUtils'
  mEnd = lines.length - 1;
