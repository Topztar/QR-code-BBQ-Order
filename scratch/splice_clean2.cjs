...
// 1. Delete Menu Item & Category states
deleteLines(
  `  // Local UI States`,
...
// 2. Delete ALL Form handlers (Reservation, Menu, Category, Table)
deleteLines(
...
deleteLines(
  ...
  50 // just delete a large chunk to get past the bulk delete modal
);

// wait, how to delete precisely until the end of Bulk Delete Orders Modal?
// Bulk Delete Orders Modal ends with `      />` then `    </div>\n  );\n};\n`
